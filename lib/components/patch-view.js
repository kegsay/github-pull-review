...
function createAnchorId(fromSha, toSha, filepath, lineNo, isLeft) {
    ...
    return "diff-" + fromSha + "-" + toSha + "-" + md5(filepath) + sep + lineNo;
}
...
module.exports = React.createClass({displayName: 'PatchView',
    propTypes: {
        ...
        fromCommitSha: React.PropTypes.string,
        toCommitSha: React.PropTypes.string,
    ...
    createAnchor: function(lineNo, isLeft) {
        ...
        return createAnchorId(
            this.props.fromCommitSha, this.props.toCommitSha, this.props.filePath, lineNo, isLeft
        );
    },

...
module.exports = React.createClass({displayName: 'MergePage',
    ...
    render: function() {
        ...
        if (this.state.flowStage === "selectMergeKind") {
            return (
                <div className="MergeOptionContainer">
                    <span onClick={this.promptForCommitMessage} className="link">{SQUASH_REWRITING_HISTORY}</span>
                    <br />
                    <span onClick={this.promptForCommitMessage} className="link">{SQUASH_MERGE}</span>
                    <br />
                    <span onClick={this.promptForCommitMessage} className="link">{MERGE_WITHOUT_SQUASH}</span>
                    <br /><br />
                    Commits:

...
class PullRequestListTrigger extends Trigger {
    ...
    constructor(pulls: Object, error: ?string) {
...
class EmailAddressesTrigger extends Trigger {
    static TYPE: string;
    emailAddresses: Array<string>;

    constructor(emailAddresses: Array<string>) {
        super(EmailAddressesTrigger.TYPE);
        this.emailAddresses = emailAddresses;
    }
}
EmailAddressesTrigger.TYPE = "email_addresses";
...
const TRIGGERS = {
    ...
    // $FlowIssue
    [EmailAddressesTrigger.TYPE]: EmailAddressesTrigger
};
...
module.exports = {
    ...
    EmailAddressesTrigger: EmailAddressesTrigger,
    ...
    TriggerMixin: function(triggersToMonitor: Array<Class<Trigger>>, dontStoreState: boolean): any {
        ...
        triggersToMonitor.forEach(function(Cls) {
            if (Object.keys(TRIGGERS).indexOf(Cls.TYPE) === -1) {
                throw new Error(
                    "TriggerMixin: Told to monitor an unknown trigger '" + Cls.TYPE +
